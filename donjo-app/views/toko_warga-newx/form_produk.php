<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href='<?= site_url("toko_warga/produk/$data")?>'><i class="fa fa-dashboard"></i> Daftar Produk</a></li>
			<li class="active">Pengaturan Foto Produk</li>
		</ol>
	</section>
	<section class="content" id="maincontent">
		<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="box-header with-border">
							<a href="<?= site_url("toko_warga/daftar_produk/$album")?>" class="btn btn-social btn-box btn-info btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"  title="Tambah Produk">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input name="nama" class="form-control input-sm nomor_sk" maxlength="50" type="text" value="<?=$produk['nama']?>"></input>
								</div>
							</div>
							<?php if ($produk['gambar']): ?>
								<div class="form-group">
									...
									<div class="col-sm-6">
									  ...
									  <img class="attachment-img img-responsive img-circle" src="<?= AmbilGaleri($produk['gambar'], 'sedang') ?>" alt="Gambar Produk">
									</div>
								</div>
							<?php endif; ?>
							<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="input-group input-group-sm">
											<input type="text" class="form-control <?php !($produk['gambar']) and print('required') ?>" id="file_path">
