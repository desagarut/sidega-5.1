            ...
            <div class="box-header with-border">
						...
						<div class="box-body">
							<div class="form-group">
								<label class="control-label col-sm-4" for="nama">Nama Toko</label>
								<div class="col-sm-6">
									<input name="nama" class="form-control input-sm nomor_sk" maxlength="50" type="text" value="<?=$toko['nama']?>"></input>
								</div>
							</div>
							<?php if ($toko['gambar']): ?>
								<div class="form-group">
									...
									<div class="col-sm-6">
									  ...
									  <img class="attachment-img img-responsive img-circle" src="<?= AmbilGaleri($toko['gambar'], 'sedang') ?>" alt="Gambar Album">
									</div>
								</div>
							<?php endif; ?>
							<div class="form-group">
							...
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-3">
                                            <input maxlength="50" class="form-control input-sm nomor_sk " name="nama_pengelola" id="nama_pengelola" value="<?=$toko['nama_pengelola']?>" type="text" placeholder="Nama pengelola" />
                                        </div>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-7">
											<textarea rows="3" class="form-control input-sm " name="alamat_tinggal" id="alamat_tinggal" placeholder="Alamat Tempat Tinggal"><?= $toko['alamat_tinggal']?></textarea>
                                        </div>
                                    </div>  
                                    <!-- End Info Pedagang -->
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input maxlength="50" class="form-control input-sm " name="no_hp_toko" id="no_hp_toko" value="<?=$toko['no_hp_toko']?>" type="text" placeholder="Contoh: 82317883161" />
                                        </div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-2">
											<input maxlength="50" class="form-control input-sm " name="jumlah_karyawan" id="jumlah_karyawan" value="<?= $toko['jumlah_karyawan']?>" type="text" placeholder="Jumlah Karyawan" />
										</div>
									</div>
									<div class="form-group">
										...
										<div class="btn-group col-sm-8 kiri" data-toggle="buttons">
											<label class="btn btn-info btn-flat btn-sm col-sm-3 form-check-label <?= $toko['lokasi'] ? NULL : 'active' ?>">
											...
											<label class="btn btn-info btn-flat btn-sm col-sm-3 form-check-label <?= $toko['lokasi'] ? 'active' : NULL ?>">
									...
									<div class="form-group">
										...
										<div id="pilih">
											<div class="col-sm-7">
												<select class="form-control input-sm select2 " id="id_lokasi" name="id_lokasi" style="width:100%">
													<option value=''>-- Pilih Lokasi Tempat Usaha --</option>
													<?php foreach ($list_lokasi as $key => $item) : ?>
														<option value="<?= $item["id"] ?>" <?php selected($item["id"], $toko['id_lokasi']) ?>><?= strtoupper($item["dusun"]) ?> <?= empty($item['rw']) ? "" : " - RW  {$item["rw"]}" ?> <?= empty($item['rt']) ? "" : " / RT  {$item["rt"]}" ?></option>
													<?php endforeach; ?>
												</select>
											</div>
										</div>
										<div id="manual">
											<div class="col-sm-7">
												<textarea id="lokasi" class="form-control input-sm " type="text" placeholder="Lokasi" name="lokasi"><?= $toko->lokasi ?></textarea>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-7">
											<textarea rows="5" class="form-control input-sm " name="keterangan_lokasi" id="keterangan_lokasi" placeholder="Keterangan Lengkap Lokasi Usaha"><?= $toko['keterangan_lokasi']?></textarea>
										</div>
									</div>
									<!--<?php if ($toko['gambar']) : ?>
										<div class="form-group">
											<label class="control-label col-sm-4" for="nama"></label>
											<div class="col-sm-6">
												<input type="hidden" name="old_foto" value="<?= $toko['gambar'] ?>">
												<img class="attachment-img img-responsive img-circle" src="<?= base_url() . LOKASI_GALERI . $toko['gambar'] ?>" alt="Gambar Tempat Usaha" width="200" height="200">
											</div>
										</div>
									<?php endif; ?>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="form-control input-sm " name="taksiran_modal" id="taksiran_modal" value="<?= $toko['taksiran_modal'] ?>" type="text" placeholder="Taksiran Modal" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input maxlength="50" class="form-control input-sm " name="taksiran_omset" id="taksiran_omset" value="<?= $toko['taksiran_omset'] ?>" type="text" placeholder="Taksiran Omset" />
										</div>
									</div>
                                    <!-- End Info Usaha -->
									...
									<div class="form-group">
										...
										<div class="col-sm-5">
											<input maxlength="50" class="form-control input-sm " name="produk_utama" id="produk_utama" value="<?= $toko['produk_utama'] ?>" type="text" placeholder="Produk Utama" />
										</div>
									</div>
									<div class="form-group">
...
<script>
	...
	$(document).ready(function() {
		pilih_lokasi(<?= is_null($toko->lokasi) ? 1 : 2 ?>);
	});
</script>
