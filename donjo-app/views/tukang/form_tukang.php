<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>Tambah Toko Warga</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('beranda')?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url('toko_warga')?>"> Daftar Toko Warga</a></li>
			<li class="active">Tambah Toko Warga</li>
		</ol>
	</section>
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<div class="col-md-12">
							<a href="<?= site_url('toko_warga')?>" class="btn btn-social btn-box btn-primary btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali Ke Daftar Pemudik Saat Covid-19"><i class="fa fa-arrow-circle-o-left"></i> Kembali Ke Daftar Toko Warga</a>
						</div>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-sm-12">
								<div class="box-header with-border">
									<h3 class="box-title">Tambahkan Data Toko</h3>
								</div>
								<div class="box-body">
									<form action="" id="main" name="main" method="POST"  class="form-horizontal">

										<div class="form-group" >
											<label class="col-sm-3 control-label required"  for="terdata">NIK / Nama Pemilik</label>
											<div class="col-sm-4">
												<select class="form-control select2 required" id="terdata" name="terdata"  onchange="formAction('main')" style="width: 100%;">
													<option value="">-- Pilih Nama / NIK Warga Pemilik Toko--</option>
											...
											<div class="col-sm-4">
												<a href="#" class="btn btn-social btn-block btn-success btn-sm" data-toggle="modal" data-target="#add-warga">
													...
													Tambah dari Penduduk Pendatang/Non Warga Desa
												</a>
												<span id="data_h_plus_msg" class="help-block">
													<code>Untuk toko yang dimiliki oleh penduduk pendatang/tidak tetap/bukan warga desa. <br/>Masukkan data pemilik toko di sini.</code>
												</span>
											</div>
										</div>
									...
									<div id="form-melengkapi-data-peserta">
										<form id="validasi" action="<?= $form_action?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
											...
											<?php if ($individu): ?>
												<?php include("donjo-app/views/toko_warga/konfirmasi_toko.php"); ?>
											<?php endif; ?>

											<?php include("donjo-app/views/toko_warga/form_isian_toko.php"); ?>
	...
	<div class='modal-dialog'>
		<div class='modal-content'>
			<div class='modal-header'>
				...
				<h4 class='modal-title' id='myModalLabel'><i class='fa fa-plus text-green'></i> Tambah dari Penduduk Pendatang / Tidak Tetap/ Non Warga</h4>
			</div>
