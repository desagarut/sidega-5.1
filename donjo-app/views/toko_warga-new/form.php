<div class="content-wrapper">
	<section class="content-header">
		<h1>Pengaturan Data Toko Warga</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('home') ?>"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="<?= site_url('toko_warga') ?>"><i class="fa fa-dashboard"></i>Daftar Toko Warga</a></li>
			<li class="active">Pengaturan Data Toko Warga</li>
		</ol>
	</section>
							...
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-2">
                                            <input maxlength="50" class="form-control input-sm required" name="nik" id="nik" value="<?= $toko->nik ?>" type="text" placeholder="NIK" />
                                        </div>
                                        <div class="col-sm-2">
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
											<input maxlength="50" class="form-control input-sm required" name="nama_usaha" id="nama_usaha" value="<?= $toko->nama_usaha ?>" type="text" placeholder="Nama Usaha/Warung/Kedai/Toko" />
										</div>
                                    </div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div id="manual">
											<div class="col-sm-7">
												<textarea id="lokasi" class="form-control input-sm required" type="text" placeholder="Lokasi" name="lokasi"><?= $toko->lokasi ?></textarea>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-7">
											<textarea rows="5" class="form-control input-sm required" name="keterangan_lokasi" id="keterangan_lokasi" placeholder="Keterangan Lengkap Lokasi Usaha"><?= $toko->keterangan_lokasi ?></textarea>
										</div>
									</div>
									<?php if ($toko->foto) : ?>
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="hidden" name="old_foto" value="<?= $toko->foto ?>">
												<img class="attachment-img img-responsive img-circle" src="<?= base_url() . LOKASI_GALERI . $toko->foto ?>" alt="Gambar Tempat Usaha" width="200" height="200">
											</div>
										</div>
									<?php endif; ?>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input class="form-control input-sm required" name="taksiran_modal" id="taksiran_modal" value="<?= $toko->taksiran_modal ?>" type="text" placeholder="Taksiran Modal" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input maxlength="50" class="form-control input-sm required" name="taksiran_omset" id="taksiran_omset" value="<?= $toko->taksiran_omset ?>" type="text" placeholder="Taksiran Omset" />
										</div>
									</div>
                                    <!-- End Info Usaha -->
									...
									<div class="form-group">
										...
										<div class="col-sm-7">
                                            <textarea id="keterangan" class="form-control input-sm" type="text" placeholder="Keterangan" name="keterangan"><?= $main->keterangan ?></textarea>											
										</div>
									</div>
