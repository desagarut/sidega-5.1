				...
				<div class="col-md-12">
					<div class="box box-info">
						<div class="box-header with-border">
							<a href="<?= site_url('toko_warga/form_produk') ?>" class="btn btn-social btn-box btn-success btn-sm btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Tambah Data Baru">
...
<script>
	$(function() {
		let tabelDokumentasi = $('#tabel-dokumentasi').DataTable({
			...
			'ajax': {
				'url': "<?= site_url("toko_warga/show_produk/{$toko_warga->id}") ?>",
				'method': 'POST'
			},
			'columns': [
				{'data': null},
