              ...
              <div class="box-body box-profile">
                ...
                <ul class="list-group list-group-unbordered" >
                  ...
                  <li class="list-group-item"><i class="fa fa-envelope margin-r-5"></i> <b>Email:</b><a class="pull-right">
                    <?= strtoupper($toko_warga->email_toko)?>
                    </a> </li>
                ...
                <a href="https://api.whatsapp.com/send?phone=+62<?= $toko_warga->no_hp_toko ?>" class="btn btn-social btn-success btn-block" target="_blank"><i class="fa fa-whatsapp"></i> Hubungi</a> </div>
              </small> </div>
            <div class="box box-primary">
...
<script>
	var map = L.map('map').setView([<?= $toko_warga->lat?>,<?= $toko_warga->lng?>], 18);
		...
		var info_tempat = "<div class='media text-center'>";
			...
			info_tempat += "<p>Nama Usaha:<b><?= $toko_warga->nama_usaha ?></b><br>Alamat: <?= strtoupper($toko_warga->alamat.'<br/> '.$toko_warga->keterangan_lokasi)?></p>";
