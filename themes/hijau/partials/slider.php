      ...
      <div class="col-md-8">
        <div class="portfolio-details-container">
          <div class="owl-carousel portfolio-details-carousel">
            ...
            <div class="portfolio-description"> <a class="archive__link" href="<?='artikel/'.buat_slug($gambar); ?>"> <img src="<?php echo base_url().$slider_gambar['lokasi'].'sedang_'.$gambar['gambar']?>" class="entry-image" alt="<?= $gambar['judul'] ?>"> </a>
