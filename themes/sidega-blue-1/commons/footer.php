  ...
  <div class="container d-md-flex py-4">
    <div class="mr-md-auto text-center text-md-left">
      <div class="copyright"> &copy;
        <?= date('Y') ?>
        <strong>tema <span> - <a href="https://desagarut.net" target="_blank">Cisompet Nyerepet</span>
        <?= THEME_VERSION ?>
        </strong></a> </div>
      <div class="credits"> Designed by <a href="https://desagarut.net/"> Rakhmat Alamsyah</a> </div>
    </div>
    <br />
    <nav class="footer-links text-lg-right text-center pt-2 pt-lg-0 navbar-dark bg-primary navbar-expand d-md-none d-lg-none d-xl-none fixed-bottom">
